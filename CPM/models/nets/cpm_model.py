...
class CPM_Model(object):
    def __init__(self, stages, joints):
        self.stages = stages
        self.stage_CPM_heatmap = []
        self.stage_PAF_heatmap= []
        self.stage_CPM_loss = [0] * stages
        self.stage_PAF_loss = [0] * stages
        self.stage_loss=[0]*stages
        self.total_loss = 0
        self.input_image = None
        self.center_map = None
        self.CPM_heatmap = None
        self.PAF_heatmap = None
        self.learning_rate = 0
        self.merged_summary = None
        self.CPM_joints = joints
        self.PAF_joints = joints+joints
        self.batch_size = 0
    ...
    def build_model(self, input_image, center_map, batch_size):
        ...
        with tf.variable_scope('sub_stages'):
            ...
            self.sub_stage_img_feature = tf.layers.conv2d(inputs=sub_conv11,
                                                          filters=128,
                                                          kernel_size=[3, 3],
                                                          strides=[1, 1],
                                                          padding='same',
        ...
        with tf.variable_scope('stage_1_CPM'):
            CPM_conv1 = tf.layers.conv2d(inputs=self.sub_stage_img_feature,
                                     filters=128,
                                     kernel_size=[3, 3],
                                     strides=[1, 1],
                                     padding='same',
            ...
            CPM_conv2 = tf.layers.conv2d(inputs=CPM_conv1,
                                         filters=128,
                                         kernel_size=[3, 3],
                                         strides=[1, 1],
                                         padding='same',
            ...
            CPM_conv3 = tf.layers.conv2d(inputs=CPM_conv2,
                                         filters=128,
                                         kernel_size=[3, 3],
                                         strides=[1, 1],
                                         padding='same',
            ...
            CPM_conv4 = tf.layers.conv2d(inputs=CPM_conv3,
                                         filters=512,
                                         kernel_size=[1, 1],
                                         strides=[1, 1],
                                         padding='same',
            ...
            self.stage_CPM_heatmap.append(tf.layers.conv2d(inputs=CPM_conv4,
                                         filters=19,
                                         kernel_size=[1, 1],
                                         strides=[1, 1],
                                         padding='same',
        ...
        with tf.variable_scope('stage_1_PAF'):
            PAF_conv1 = tf.layers.conv2d(inputs=self.sub_stage_img_feature,
                                         filters=128,
                                         kernel_size=[3, 3],
                                         strides=[1, 1],
                                         padding='same',
            ...
            PAF_conv2 = tf.layers.conv2d(inputs=PAF_conv1,
                                         filters=128,
                                         kernel_size=[3, 3],
                                         strides=[1, 1],
                                         padding='same',
            ...
            PAF_conv3 = tf.layers.conv2d(inputs=PAF_conv2,
                                         filters=128,
                                         kernel_size=[3, 3],
                                         strides=[1, 1],
                                         padding='same',
            ...
            PAF_conv4 = tf.layers.conv2d(inputs=PAF_conv3,
                                         filters=512,
                                         kernel_size=[1, 1],
                                         strides=[1, 1],
                                         padding='same',
            ...
            self.stage_PAF_heatmap.append(tf.layers.conv2d(inputs=PAF_conv4,
                                                           filters=38,
                                                           kernel_size=[1, 1],
                                                           strides=[1, 1],
                                                           padding='same',
    ...
    def _middle_conv(self, stage):
        with tf.variable_scope('stage_' + str(stage)):
            self.current_featuremap = tf.concat([self.stage_CPM_heatmap[stage - 1],
                                                 self.stage_PAF_heatmap[stage -1],
                                                 self.sub_stage_img_feature
                                                 ],
                                                axis=3)
            mid_CPM_conv1 = tf.layers.conv2d(inputs=self.current_featuremap,
                                         filters=128,
                                         kernel_size=[3, 3],
                                         strides=[1, 1],
                                         padding='same',
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(),
                                         name='mid_CPM_conv1')
            mid_CPM_conv2 = tf.layers.conv2d(inputs=mid_CPM_conv1,
                                         filters=128,
                                         kernel_size=[3, 3],
                                         strides=[1, 1],
                                         padding='same',
                                         ...
                                         kernel_initializer=tf.contrib.layers.xavier_initializer(),
                                         name='mid_CPM_conv2')
            mid_CPM_conv3 = tf.layers.conv2d(inputs=mid_CPM_conv2,
                                         filters=512,
                                         kernel_size=[1, 1],
                                         strides=[1, 1],
                                         padding='same',
            ...
            self.current_CPM_heatmap = tf.layers.conv2d(inputs=mid_CPM_conv3,
                                                    filters=self.CPM_joints,
                                                    kernel_size=[1, 1],
                                                    strides=[1, 1],
                                                    padding='same',
                                                    kernel_initializer=tf.contrib.layers.xavier_initializer(),
                                                    name='current_CPM_heatmap')
            self.stage_CPM_heatmap.append(self.current_CPM_heatmap)

            mid_PAF_conv1 = tf.layers.conv2d(inputs=self.current_featuremap,
                                             filters=128,
                                             kernel_size=[3, 3],
                                             strides=[1, 1],
                                             padding='same',
                                             ...
                                             kernel_initializer=tf.contrib.layers.xavier_initializer(),
                                             name='mid_PAF_conv1')
            mid_PAF_conv2 = tf.layers.conv2d(inputs=mid_PAF_conv1,
                                             filters=128,
                                             kernel_size=[3, 3],
                                             strides=[1, 1],
                                             padding='same',
                                             ...
                                             kernel_initializer=tf.contrib.layers.xavier_initializer(),
                                             name='mid_PAF_conv2')
            mid_PAF_conv3 = tf.layers.conv2d(inputs=mid_CPM_conv2,
                                             filters=512,
                                             kernel_size=[1, 1],
                                             strides=[1, 1],
                                             padding='same',
            ...
            self.current_PAF_heatmap = tf.layers.conv2d(inputs=mid_PAF_conv3,
                                                        filters=self.PAF_joints,
                                                        kernel_size=[1, 1],
                                                        strides=[1, 1],
                                                        padding='same',
                                                        kernel_initializer=tf.contrib.layers.xavier_initializer(),
                                                        name='current_PAF_heatmap')
            self.stage_PAF_heatmap.append(self.current_PAF_heatmap)


    def build_loss(self, CPM_heatmap, PAF_heatmap, lr, lr_decay_rate, lr_decay_step):
        self.CPM_heatmap = CPM_heatmap
        self.PAF_heatmap = PAF_heatmap
        self.total_loss = 0
        ...
        for stage in range(self.stages):
            with tf.variable_scope('stage' + str(stage + 1) + '_loss'):
                self.stage_CPM_loss[stage] = tf.nn.l2_loss(self.stage_CPM_heatmap[stage] - self.CPM_heatmap,
                                                       name='CMP_l2_loss') / self.batch_size
                self.stage_PAF_loss[stage] = tf.nn.l2_loss(self.stage_PAF_heatmap[stage] - self.PAF_heatmap,
                                                       name='PAF_l2_loss') / self.batch_size
                self.stage_loss[stage] = self.stage_CPM_loss[stage] + self.stage_PAF_loss[stage]
            tf.summary.scalar('stage' + str(stage + 1) + '_CPM_loss', self.stage_CPM_loss[stage])
            tf.summary.scalar('stage' + str(stage + 1) + '_PAF_loss', self.stage_PAF_loss[stage])
